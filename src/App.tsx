...
import type { CreateNotebookRequest, GetAllNotebookResponse, MoveNotebookRequest, MoveNotebookResponse } from "./dto/notebook"
...
export default function App() {
  ...
  const fetchAllNotebooks = async () => {
    const res = await axios.get<BaseResponse<GetAllNotebookResponse[]>>(
...
fetchAllNotebooks()
  ...
  const handleMoveNotebook = async (notebookId: string, targetParentId: string | null) => {
    ...
    await axios.put<BaseResponse<MoveNotebookResponse>>(`${AppConfig.baseUrl}/api/notebook/v1/${notebookId}/move`, request)
  ...
  const handleCreateNotebook = async () => {
    ...
    setIsCreatingNotebook(true)
      ...
      await axios.post<BaseResponse<CreateNotebookRequest>>(`${AppConfig.baseUrl}/api/notebook/v1`, request)
